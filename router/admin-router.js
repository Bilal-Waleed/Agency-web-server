...
router.post("/orders/:id/cancel",  isAdminMiddleware, cancelOrderByAdmin);
router.post("/orders/:id/complete",  isAdminMiddleware, upload.array('files'), completeOrder);
router.get("/cancel-requests", isAdminMiddleware, getCancelRequests);
router.post("/cancel-requests/:id/accept", isAdminMiddleware, acceptCancelRequest);
router.post("/cancel-requests/:id/decline", isAdminMiddleware, declineCancelRequest);
